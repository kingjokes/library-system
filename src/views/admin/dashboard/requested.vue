...
<template>
  <div class="container">
    ...
    <div
      ...
      :key="index"
    >
      <router-link :to="{ name: 'adminBookDetails', params: { id: item.id } }">
        <div class="d-flex flex-row">
          ...
          <div>
            ...
            <div class="d-flex flex-row">
              <div>
                <span class="request">Requested By</span>
                <br />
                <span class="request-content">{{ item.User.lastname }} {{ item.User.firstname }}</span>
              </div>
              <v-spacer></v-spacer>
              <div>
                <span class="request">Requested Date</span>
                <br />
                <span class="request-content">{{ dateFormatter(item.request_date) }}</span>
              </div>
            </div>
